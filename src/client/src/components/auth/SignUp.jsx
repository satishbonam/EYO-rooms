    ...
    return (
      <form id={styles.signupform}>
        <div className="form-group">
          ...
          />
          <small className={isNameValid ? "d-block" : "d-none"}>
            not valid name
          </small>
        </div>
        <div className="form-group">
          ...
          />
          <small className={isUsernameValid ? "d-block" : "d-none"}>
            not valid username
          </small>
        </div>
        <div className="form-group">
          ...
          <input
            ...
            aria-describedby="emailHelp"
          />
          <small className={isEmailValid ? "d-block" : "d-none"}>
            not an valid email
          </small>
        </div>
        <div className="form-group">
          ...
          <input
            ...
            id="exampleInputPassword1"
          />
          <small className={isPasswordValid ? "d-block" : "d-none"}>
            not valid password
          </small>
        </div>
        <div className="form-group">
          ...
          <input
            ...
            id="exampleInputPassword1"
          />
          <small className={isMobileValid ? "d-block" : "d-none"}>
            not valid mobile
          </small>
        </div>
