...
import { faStar ,faDoorClosed, faCalendar ,faFan, faToilet, faPersonBooth, faMusic,faHandHoldingWater,faMoneyBillWave,faBreadSlice,faWifi,faFire, faHotTub,faCheese, faRestroom,faParking,faBed, faThermometerEmpty, faChair, faTv, faSoap} from "@fortawesome/free-solid-svg-icons"
          ...
          <div class="card w-100 ">
            <div class="card-body">
              <div className="d-flex">
                <div className="col-9">
                  <div id={styles.heading}>EYO Flagship 30106 Prafulla Devi Guest House Rajarhat Chomatha</div>
                  <div className="d-flex align-items-center">
                    <div id={styles.ratingContainer}>
                      <span>4.6</span>
                      <span>
                        <FontAwesomeIcon icon={faStar} color="#f0f0f0" size="sm" />
                      </span>
                    </div>
                ...
                <div className="col-3">
                  <img src="/images/bed.webp" id={styles.img} className="card-img " alt="" />
                </div>
              </div>
              <div className="d-flex justify-content-between pl-0" id={styles.SecduleContainer}>
                <div>
                  <span>
                    <FontAwesomeIcon icon={faCalendar} color="#f0f0f0" size="lg" />
                  </span>
              ...
              <div className="d-flex justify-content-between pl-0" id={styles.quality}>
                <div>
                  <span>
              ...
              <div id={styles.tagContainer}>
                {[
                  { priceDes: "Room price for 3 Nights X 3 Guests", amount: "₹36198" },
